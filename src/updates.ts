export const LATEST_PACKAGE_URL = "https://github.com/Boom-laba/scripting-due-manager/releases/latest/download/due-manager.scripting"
const RELEASE_API_URL = "https://api.github.com/repos/Boom-laba/scripting-due-manager/releases/latest"
const RELEASE_BASE_URL = "https://github.com/Boom-laba/scripting-due-manager/releases"
...
export async function checkLatestRelease(): Promise<ReleaseInfo> {
  throw new Error("当前为云邮件定制版，已禁用上游更新，避免覆盖邮件功能。")
}
